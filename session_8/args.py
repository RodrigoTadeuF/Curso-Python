...
print(soma_todos_numeros('Rodrigo', 'Tadeu'))
print(soma_todos_numeros('Rodrigo', 'Tadeu', 1))
print(soma_todos_numeros('Rodrigo', 'Tadeu', 2, 3))
print(soma_todos_numeros('Rodrigo', 'Tadeu', 2, 3, 4))
print(soma_todos_numeros('Rodrigo', 'Tadeu', 3, 4, 5, 6))
print(soma_todos_numeros('Rodrigo', 'Tadeu', 23.4, 12.5))
